  ...
  <div>
    ...
    <div class="head">
      ...
      <div class="middle_box">
        ...
        <!-- 标题 -->
        <div class="headline">{{orderList.activity_name}}</div>
        <div class="voucher">电子凭证</div>
        <!-- 二维码 -->
        <div class="two_code">
          <image :src="'data:image/png;base64,'+ orderList.png"></image>
        </div>
        <!-- 兑换码 -->
        <div class="conversion">兑换码:&nbsp;{{orderList.exchange_code}}</div>
      </div>
      <!-- 底部空盒子 -->
    ...
    <div class="centre">
      ...
      <div class="activity_centre">
        ...
        <div class="name_site">
          ...
          <p>活动名称:&nbsp;&nbsp;
            <span class="merchant">{{orderList.activity_name}}</span>
          </p>
        </div>
      ...
      <div class="activity_centre">
        ...
        <div class="order_content">
          ...
          <p>下单时间:&nbsp;&nbsp;
            <span class="word_black">{{orderList.pay_time}}</span>
          </p>
          <p>商品名称:&nbsp;&nbsp;
            <span class="word_black">{{orderList.activity_name}}</span>
          </p>
          <p>数&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;量:&nbsp;&nbsp;
            <span class="word_black">×{{orderList.number}}</span>
          </p>
          <p>付款金额:&nbsp;&nbsp;
  ...
  methods: {
    getData() {
      ...
      request.get('/order/order_details', {
        ...
        this.orderList.pay_time = time.formatTime(this.orderList.pay_time, 'Y/M/D h:m:s')
      })
    }
  },
  onLoad(options) {
