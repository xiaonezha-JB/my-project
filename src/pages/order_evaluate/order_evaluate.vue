  ...
  <div>
    ...
    <div class="head">
      ...
      <div class="middle_box">
        ...
        <!-- 兑换码 -->
        <div class="conversion">兑换码:&nbsp;{{orevList.exchange_code}}</div>
      </div>
      <!-- 底部空盒子 -->
    ...
    <!-- 底部 -->
    <div class="purchase">
      <navigator  hover-class="none" style="none" :url="'/pages/user_evaluate/main?id=' + orevList.id">
